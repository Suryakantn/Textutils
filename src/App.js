      ...
      <Router>
        ...
        <div className="container">
          <Routes>
            ...
            <Route exact path="/" element={<TextForm heading="Enter you text below" mode={mode} showAlert={showAlert} />} />
            {/* <Route path="/about">
              <About />
            </Route>
            <Route path="/">
              <TextForm heading="Enter you text below" mode={mode} showAlert={showAlert} />
            </Route> */}
          </Routes>
        </div>
      </Router>
